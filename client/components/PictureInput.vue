<template>
  <div id="picture-input" ref="container" class="picture-input">
    ...
    <div v-else-if="supportsPreview">
      <div :style="{maxWidth: previewWidth + 'px', height: previewHeight + 'px', borderRadius: radius + '%'}"
    ...
    <input ref="fileInput" :name="name" :id="id" :accept="accept" type="file" @change="onFileChange">
  </div>
</template>
