<template>
  <div class="container">
      ...
      <div class="col">
        ...
        <ol>
          ...
          <li>
            ...
            <mark for="site">https://skidvis.ru</mark>.
          </li>
        </ol>
        <p/>
      </div>
    ...
    <div class="row mb-4">
      <div class="col">
        <p class="m-0 p-0"/><h4 id="list-3">3. Оператор может обрабатывать следующие персональные данные Пользователя</h4>
        <p/>
        <p class="mb-4"/>
      ...
      <div class="col">
        ...
        <ol>
          <li>
            ...
            <mark for="processingTargetResult">информирование Пользователя посредством отправки электронных
            писем; уточнение деталей заказа.
            </mark>
          </li>
          <li>
    ...
    <div class="row mb-4">
      <div class="col">
        <p class="m-0 p-0"/><h4 id="list-5">5. Правовые основания обработки персональных данных</h4>
        <p/>
        <p class="mb-4"/>
        <ol>
          <li>
    ...
    <div class="row mb-4">
      <div class="col">
        <p class="m-0 p-0"/><h4 id="list-6">6. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h4>
        <p/>
        <span>
    ...
    <div class="row mb-4">
      <div class="col">
        <p class="m-0 p-0"/><h4 id="list-7">7. Трансграничная передача персональных данных</h4>
        <p/>
        <p class="mb-4"/>
        <ol>
          <li>
    ...
    <div class="row mb-4">
      <div class="col">
        <p class="m-0 p-0"/><h4 id="list-8">8. Заключительные положения</h4>
        <p/>
        <p class="mb-4"/>
        <ol>
          <li>
